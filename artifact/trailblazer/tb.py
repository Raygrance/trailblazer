...
def run(args):
    if args.mode == "s":
        ...
        # print(args.n)
        # print(args.m)
        run_fuzz(args.target, args.n, args.m, args.r, args.g, args.header)
    elif args.mode == "r":
...
"""
    ...
    parser_f.add_argument('-r', action="store_true", help="Generated payloads based on traffic captured from host")
    parser_f.add_argument('-g', action="store_true", help="Replay exact captured traffic from host")
